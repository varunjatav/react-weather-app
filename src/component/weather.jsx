...
const Weather = () => {
  ...
  useEffect(() => {
    const url = `https://api.openweathermap.org/data/2.5/weather?q=$jhansi&units=Metric&appid=${api_key}`;
  ...
  // background-color: ;
  return (
    <div className="pt-5 h-full w-[400px] m-auto rounded-md py-5 text-center">
      ...
      <div className="flex items-center justify-center gap-2 w-[300px] m-auto bg-white rounded-full ">
        <div>
          <input
            type="text"
            placeholder="Search.."
            className="p-4 border-none text-black focus:border-none"
            id="city_input"
            onInput={(e) => Input(e)}
          />
        </div>
      ...
      <img
        src="https://www.pngmart.com/files/3/Weather-PNG-Photos.png"
        alt="cloud"
        className="m-auto"
        width="200px"
      />
